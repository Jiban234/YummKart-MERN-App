...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible">
      ...
      {/* for small devices */}
      {showSearch && (
        <div className="w-[90%]  h-[70px] bg-white shadow-xl rounded-lg flex fixed items-center gap-[20px] px-4 top-[80px] left-[5%]">
          {/* Location */}
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="hidden md:block px-4 py-2 rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d] text-sm font-medium hover:bg-[#ff4d2d]/20 transition-all duration-200 cursor-pointer">
          My Orders
        </button>

        <div
          className="w-10 h-10 flex items-center justify-center rounded-full bg-[#ff4d2d]/10 text-[#ff4d2d] font-semibold text-lg uppercase shadow-sm border border-[#ff4d2d]/20 cursor-pointer"
